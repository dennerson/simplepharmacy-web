...
class HomeView(ListView):
    model = Item.objects.all().order_by('-date_created')
    ...
    def get(self, request, *args, **kwargs):
        if 'search_item' in request.GET:
            ...
            multiple_search = Q(Q(title__icontains=search_item) | Q(
                category__icontains=search_item) | Q(label__icontains=search_item))
            data = Item.objects.all().filter(multiple_search)
